...
const Footer: React.FC<FooterProps> = ({ companyName, year }) => {
	return (
		...
		<footer className="bg-black rounded-lg shadow dark:bg-gray-900 m-4 foter">
			<div className="w-full max-w-screen-xl mx-auto p-4 md:py-8">
				<div className="sm:flex sm:items-center sm:justify-between container-button-about-footer">
				...
				<p className='correo-footer'>Correo: hmusic.poyecto@gmail.com</p>
				<hr className="my-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8" />
				<span className="block text-sm text-white sm:text-center dark:text-gray-400">© {year} <a href="" className="hover:underline">{companyName}</a>. All Rights Reserved.</span>
			</div>
		</footer>
